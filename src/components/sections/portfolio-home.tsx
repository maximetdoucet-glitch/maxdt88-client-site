...
export function PortfolioHome({ showContent }: PortfolioHomeProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full bg-black text-white selection:bg-[#1d4ed8]/30">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-24">
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#1d4ed8]">Creators</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#1d4ed8]">Athletes</h3>
                <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl">
              ...
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#1d4ed8]">Brands</h3>
                <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl">
