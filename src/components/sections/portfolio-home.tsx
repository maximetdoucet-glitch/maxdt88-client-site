...
export function PortfolioHome({ showContent }: PortfolioHomeProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full bg-black">
      ...
      {/* 5. FOR WHO / BRANDS */}
      <section id="target" className="py-40 px-6 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { 
                title: "Athletes", 
                desc: "Dynamic storytelling that captures the intensity of performance and builds a direct connection with your audience." 
              },
              { 
                title: "Creative Artists", 
                desc: "Elevating your distinct aesthetic with rhythmic editing and cinematic visuals that amplify your creative voice." 
              },
              { 
                title: "Modern Brands", 
                desc: "Strategic video content designed to dominate attention, increase watch time, and drive measurable brand growth." 
              }
            ].map((tier, i) => (
      ...
      {/* 6. FINAL CTA */}
      <section id="contact" className="py-48 px-6 text-center border-t border-white/5 bg-gradient-to-b from-black to-[#050505]">
