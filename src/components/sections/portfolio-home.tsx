    ...
    <div ref={containerRef} className="relative w-full bg-black text-white selection:bg-[#0369a1]/30">
      ...
      >
        <NeuralBackground 
          ...
          speed={1.2} // High vitality (v6 speed)
          trailOpacity={0.01} // Cinematic trails
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-24">
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#0369a1]">Creators</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#0369a1]">Athletes</h3>
                <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl">
              ...
              <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-bold text-[#0369a1]">Brands</h3>
                <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl">
