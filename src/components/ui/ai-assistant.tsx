            ...
            <div className="p-6 border-b border-[#0a0a0a]/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#0a0a0a] rounded-xl flex items-center justify-center">
                  <PenTool className="w-4 h-4 text-[#2196f3]" />
                </div>
                <div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
                ...
                {SKILLS.map((skill) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === skill.id 
                        ? "bg-white border-[#2196f3]/20 shadow-sm" 
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  {inputValue && (
                     <button 
                      ...
                      className="text-[0.6rem] font-bold text-[#2196f3] uppercase tracking-widest"
                    >
                      Clear
                    </button>
                  )}
                ...
                <textarea
                  ...
                  className="w-full h-32 bg-white/50 border border-[#0a0a0a]/5 rounded-2xl p-4 text-sm text-[#0a0a0a] placeholder-[#0a0a0a]/20 focus:outline-none focus:border-[#2196f3]/30 focus:bg-white transition-all resize-none"
                />
              </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  !inputValue 
                    ...
                    : "bg-[#0a0a0a] text-[#f4ebd0] hover:bg-[#2196f3] shadow-lg shadow-[#2196f3]/10"
                )}
              >
                {isProcessing ? (
                  <>
              ...
              {result && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="bg-[#2196f3]/5 border border-[#2196f3]/10 rounded-2xl p-6">
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-6 h-6 bg-[#2196f3] rounded-lg flex items-center justify-center">
                        <Check className="w-3.5 h-3.5 text-[#f4ebd0]" />
                      </div>
                      <span className="text-[0.65rem] font-black uppercase tracking-widest text-[#2196f3]">Optimization Complete</span>
                    </div>
