...
export function DownloadProtocol({ elementId, fileName }: DownloadProtocolProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center gap-2 px-4 py-2 bg-[#0a0a0a] text-[#f4ebd0] rounded-xl text-[0.65rem] font-bold uppercase tracking-widest hover:bg-[#2196f3] transition-all duration-300 disabled:opacity-50",
