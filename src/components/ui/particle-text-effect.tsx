...
class Particle {
  ...
  kill(width: number, height: number) {
    if (!this.isKilled) {
      ...
      this.targetColor = { r: 10, g: 10, b: 10 }
      this.colorWeight = 0
...
const DEFAULT_WORDS = ["SILENT", "STRENGTH", "DISCIPLINE", "ROUTINE", "BASELINE"]
...
export function ParticleTextEffect({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <canvas
        ref={canvasRef}
        className="rounded-lg shadow-2xl max-w-full h-auto bg-black"
      />
    </div>
  )
}
