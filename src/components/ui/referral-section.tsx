      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-left space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#3b82f6]/10 border border-[#3b82f6]/20 rounded-full">
            ...
            <TextShimmer baseColor="#3b82f6" shimmerColor="#ffffff" className="text-[0.65rem] font-bold uppercase tracking-widest">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight text-[#0a0a0a]">
            Refer a builder,<br /> 
            <TextShimmer baseColor="#3b82f6" shimmerColor="#ffffff" className="text-3xl md:text-5xl font-black">Expand the Bazaar.</TextShimmer>
          </h2>
          ...
          <div className="flex items-center gap-6 pt-4">
            <div className="flex -space-x-3">
              ...
              <div className="w-10 h-10 rounded-full border-2 border-[#f4ebd0] bg-[#3b82f6] flex items-center justify-center text-[0.6rem] font-bold text-[#f4ebd0]">
                +50k
              </div>
            </div>
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-[#3b82f6]/5 rounded-[2.5rem] blur-2xl transform rotate-3" />
          <div className="glass relative rounded-[2.5rem] p-8 border-[#0a0a0a]/5 shadow-2xl shadow-[#0a0a0a]/5 overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-2">
                <TextShimmer baseColor="#3b82f6" shimmerColor="#ffffff" className="text-[0.65rem] font-bold uppercase tracking-[0.2em]">
                  Your Referral Link
                </TextShimmer>
                <div className="flex items-center gap-2 p-4 bg-[#0a0a0a]/5 rounded-2xl border border-[#0a0a0a]/5 group hover:border-[#3b82f6]/20 transition-all">
                  <code className="flex-1 text-sm font-medium text-[#0a0a0a]/70 truncate">
                    {referralLink}
                  </code>
                  <button 
                    onClick={handleCopy}
                    className="p-2 hover:bg-[#3b82f6]/10 rounded-xl transition-colors text-[#3b82f6]"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-2 py-4 bg-[#0a0a0a] text-[#f4ebd0] rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-[#3b82f6] transition-all duration-300">
                  <Share2 className="w-4 h-4" />
                  Share Meta
                </button>
                <button className="flex items-center justify-center gap-2 py-4 bg-transparent border border-[#0a0a0a]/10 text-[#0a0a0a] rounded-2xl font-bold text-xs uppercase tracking-widest hover:border-[#3b82f6] hover:text-[#3b82f6] transition-all duration-300">
              ...
              <div className="pt-4 border-t border-[#0a0a0a]/5">
                <div className="flex items-center justify-between text-[0.7rem] font-bold uppercase tracking-widest mb-4 text-[#0a0a0a]/40">
                  ...
                  <TextShimmer baseColor="#3b82f6" shimmerColor="#ffffff" className="text-[0.7rem] font-bold uppercase tracking-widest">Level 2 Builder</TextShimmer>
                </div>
