  ...
  "tracking-tight pb-3 bg-clip-text text-transparent",
  {
    variants: {
      ...
      size: {
        ...
        xll: "text-5xl sm:text-6xl lg:text-[5.4rem]  lg:leading-[5rem] ",
...
const GradientHeading = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ asChild, variant, weight, size, className, children, ...props }, ref) => {
    ...
    return (
      <Comp ref={ref} {...props} className={cn("inline-block", className)}>
...
export type Variant = "default" | "pink" | "light" | "secondary" | "white"
export type Size =
  | "default"
  | "xxs"
  | "xs"
