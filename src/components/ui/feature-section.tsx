  ...
  return (
    <div className={cn("py-8 md:py-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-10 text-center text-[#f4ebd0]">
          {title}
        </h2>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
            ...
            {features.map((feature, index) => (
              ...
              >
                <motion.div
                  className={cn(
                    ...
                    index === currentFeature
                      ? "bg-[#2196f3] border-[#2196f3] text-[#f4ebd0] scale-110"
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-[#f4ebd0]">
                    {feature.title || feature.step}
                  </h3>
                  <p className="text-sm md:text-lg text-[#9ca3af] mt-1">
                    {feature.content}
                  </p>
                </div>
              </motion.div>
          ...
          <div
            className={cn(
              "order-1 md:order-2 relative h-[250px] md:h-[400px] lg:h-[500px] overflow-hidden rounded-[2rem] border border-[#333] shadow-2xl shadow-black/50"
            )}
          >
