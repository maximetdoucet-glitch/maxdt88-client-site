...
const renderCanvas = ({
  ...
  const color = parseColor(framerProps.color ?? "rgb(0, 0, 0)");
  ...
  particles.forEach(particle => {
    ...
    if (shouldVaporize) {
      ...
      if (particle.shouldFadeQuickly) {
        ...
        particle.velocityX = (particle.velocityX + (Math.random() - 0.5) * 5) * dampingFactor;
        particle.velocityY = (particle.velocityY + (Math.random() - 0.5) * 5) * dampingFactor;
