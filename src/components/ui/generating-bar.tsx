...
export const GeneratingBar = ({ 
  ...
  return (
    <div
      className={cn(
        "flex items-center h-[3.5rem] px-6 bg-[#0a0a0a]/80 backdrop-blur border border-[#0369a1]/20 rounded-[1.7rem] text-sm text-[#f4ebd0]",
        className
      )}
    >
      <Loader2 className="w-5 h-5 mr-4 text-[#0369a1] animate-spin" />
